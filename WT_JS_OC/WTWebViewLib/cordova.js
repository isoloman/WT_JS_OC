...
function convertMessageToArgsNativeToJs(message) {
    var args = [];
    if (!message || !message.hasOwnProperty('WTType')) {
        args.push(message);
    } else if (message.WTType == 'MultiPart') {
...
exports.mapModules = function (context) {
    var origSymbols = {};
    context.WT_origSymbols = origSymbols;
...
exports.getOriginalSymbol = function (context, symbolPath) {
    var origSymbols = context.WT_origSymbols;
